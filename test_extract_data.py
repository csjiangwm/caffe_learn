...
deploy_file = "./cifar10_quick_test.prototxt"
model_file  = "./yourcaffemodel"
test_data   = "./dataset/test/300.jpg"
...
if __name__ == '__main__':
    ...
    # input_dim: 28
    # input_dim: 28
    transformer = caffe.io.Transformer({'data': net.blobs['data'].data.shape}) #类似于placeholder？
...
#    img = caffe.io.load_image(test_data,color=False)
    ...
    inputBlob = cv2.dnn.blobFromImage(img,1,size=(256,256),mean=(100,114,121))
    # 数据输入、预处理
#    net.blobs['data'].data[...] = transformer.preprocess('data', img)
    net.blobs['data'].data[...] = inputBlob
    ...
    show_data(feature.reshape(32,256,256))
